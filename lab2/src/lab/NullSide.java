...
/**
 * A null side is a side of a room that does nothing. It is the default side of
 * a room and is later replaced.
 * 
...
public class NullSide extends MapSite {
	...
	/**
	 * Prints a message stating that something is wrong because something is
	 * trying to enter a null side.
	 * 
	 * @param p
	 *            Entering moving object.
	 */
